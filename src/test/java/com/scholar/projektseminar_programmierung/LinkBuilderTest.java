...
class LinkBuilderTest {
	...
	void testIfLinkGetsCreatedCorrectly_yearBeginIsNegative() {
		assertEquals("https://scholar.google.de/scholar?hl=de&as_sdt=0%2C5&q=natural+AND+disaster&hl=de&as_sdt=0%2C5&as_ylo=&as_yhi=", linkBuilderTest.buildLink("natural AND disaster", -2010, 0));
	}
	
	@Test
	void testIfLinkGetsCreatedCorrectly_yearEndIsNegative() {
		assertEquals("https://scholar.google.de/scholar?hl=de&as_sdt=0%2C5&q=natural+AND+disaster&hl=de&as_sdt=0%2C5&as_ylo=&as_yhi=", linkBuilderTest.buildLink("natural AND disaster", 0, -2010));
	}
	
	@Test
	void testIfLinkGetsCreatedCorrectly_yearBeginAndYearEndAreNegative() {
		assertEquals("https://scholar.google.de/scholar?hl=de&as_sdt=0%2C5&q=natural+AND+disaster&hl=de&as_sdt=0%2C5&as_ylo=&as_yhi=", linkBuilderTest.buildLink("natural AND disaster", -2015, -2020));
	}
}
